...
class LoginForm(FlaskForm):
    portfolio_id = StringField('Wallet ID',
...
class StudentregistrationForm(FlaskForm):
    ...
    email = StringField('Email', validators=[validators.DataRequired(),validators.Length(1,64),validators.Email(),])
    ...
    passwordconfirm = PasswordField('confirm', validators=[validators.DataRequired()
                                                       ])
